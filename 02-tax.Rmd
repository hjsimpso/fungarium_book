...
data4 <- data3[data3$occurrenceRemarks!=""|data3$host!=""|
                   data3$habitat!=""|data3$substrate!="",]

#find trait-relevant records
trait_data <- find_trait(data4, c("occurrenceRemarks", "host", "habitat", "substrate"),
...
agaricales_enrich2 <- agaricales_enrich[agaricales_enrich$max_bias<=0.75,]

#filter for taxa with at least 5 total records
agaricales_enrich3 <- agaricales_enrich2[agaricales_enrich2$freq>=5,]

#make rectangular cladogram
library(ggtree)
library(ggplot2)

trait_clado(data=agaricales_enrich3, trait_col="trait_ratio", continuous=TRUE,
