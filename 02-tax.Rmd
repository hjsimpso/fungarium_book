...
data <- taxon_update(strophariaceae, species_only=TRUE) 
...
```{r circle_clado, fig.cap='Circle cladogram showing fire-association enrichment among Strophariaceae species', out.width='80%', fig.asp=.75, fig.align='center', eval=FALSE}
